      ...
      <tr className="border-b border-border align-top last:border-b-0">
        ...
        <td className="px-4 py-3">
          {hasDetails ? (
            <button
              type="button"
              className="inline-flex min-h-11 items-center text-xs font-medium text-muted-foreground underline-offset-2 hover:text-foreground hover:underline sm:min-h-0"
