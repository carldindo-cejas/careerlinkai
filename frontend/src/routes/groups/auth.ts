 ...
 *
 * Counselor sign-in, counselor self-registration, the unlinked administrator sign-in, the reset
 * pair, and the forced password change — every screen that hands a password to `StaffAuthLayout`.
 * The student's door is **not** here: `/join` takes no password (§38) and is its own group, so a
...
export { CounselorSignupPage } from '@/features/auth/pages/CounselorSignupPage';
